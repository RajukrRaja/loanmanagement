...
<head>
    <meta charset="UTF-8">
    <title>Sub Branch Admin Dashboard</title>
    ...
    <div class="row">
        ...
        <nav id="sidebarMenu" class="col-lg-2 col-md-3 d-md-block sidebar py-4">
            <div class="text-center mb-4">
                <img src="https://ui-avatars.com/api/?name=Sub+Branch+Admin" alt="Profile" class="profile-img mb-2">
                <h5>Sub Branch Admin</h5>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#employeesTable"><i class="fas fa-users me-2"></i> Manage Employees</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><i class="fas fa-money-check-alt me-2"></i> Collections</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#emiTable">EMI Tracking</a></li>
                        <li><a class="dropdown-item" href="#leadsTable">Lead Tracking</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#approvalsTable"><i class="fas fa-check-circle me-2"></i> Approvals</a>
                </li>
                <li class="nav-item">
        ...
        <main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4" style="transition: margin-left 0.3s;">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="h3 mb-0 fw-bold" style="letter-spacing:0.01em;">Sub Branch Dashboard (Downtown - East)</h2>
                </div>
            ...
            <div class="row mb-4 g-3">
                    ...
                    <div class="card card-stats shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0">Sub Branch Employees</h6>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats shadow-sm">
                        ...
                        <div class="card-footer text-muted small">
                            <i class="fas fa-arrow-down text-danger"></i> 1 less than last week
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="mb-0 fw-bold">$3,200</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-muted small">
                            <i class="fas fa-arrow-up text-success"></i> 3% this month
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
            ...
            <div class="row mb-4 g-3">
                <div class="col-md-3 col-6">
                    <a href="#" class="btn btn-outline-primary w-100 py-3 shadow-sm" data-bs-toggle="modal" data-bs-target="#newEmployeeModal"><i class="fas fa-user-plus me-2"></i>Add Employee</a>
                </div>
                <div class="col-md-3 col-6">
                ...
                <div class="col-md-3 col-6">
                    <a href="#" class="btn btn-outline-info w-100 py-3 shadow-sm" data-bs-toggle="modal" data-bs-target="#assignLeadModal"><i class="fas fa-user-check me-2"></i>Assign Lead</a>
                </div>
                <div class="col-md-3 col-6">
                    <a href="#" class="btn btn-outline-warning w-100 py-3 shadow-sm" data-bs-toggle="modal" data-bs-target="#generateReportModal"><i class="fas fa-file-alt me-2"></i>Generate Report</a>
                </div>
            </div>
            <!-- Modals -->
            <!-- New Employee Modal -->
                            ...
                            <form id="assignLeadForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="employee" class="form-control" required>
                                        <option value="E001">John Smith</option>
                                        <option value="E002">Sarah Lee</option>
                                    </select>
                                </div>
            ...
            <div class="card mb-4 shadow-sm" id="employeesTable">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Sub Branch Employees</h5>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-sm btn-outline-primary edit-employee" data-employee-id="E001" data-bs-toggle="modal" data-bs-target="#editEmployeeModal"><i class="fas fa-edit"></i></a>
                                        <button class="btn btn-sm btn-outline-danger delete-employee" data-employee-id="E001">Delete</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="card mb-4 shadow-sm" id="leadsTable">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Lead Tracking</h5>
                    <a href="#" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0 align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-warning text-dark">Pending</span></td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-outline-primary assign-lead" data-lead-id="LD101" data-bs-toggle="modal" data-bs-target="#assignLeadModal"><i class="fas fa-check"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <!-- Approvals Table -->
            <div class="card mb-4 shadow-sm" id="approvalsTable">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Branch Approvals</h5>
                    <a href="#" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table mb-0 align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$1,000 for Loan Disbursement</td>
                                    <td><span class="badge bg-warning text-dark">Pending</span></td>
                                    <td>
                                        <button class="btn btn-sm btn-outline-success approve-request" data-request-id="WR1001">Approve</button>
                                        <button class="btn btn-sm btn-outline-danger reject-request" data-request-id="WR1001">Reject</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Sub Branch meeting on <strong>2025-06-05</strong> at 11:00 AM.</li>
                        <li class="list-group-item">New EMI collection target assigned. <a href="#">Read more</a></li>
                        <li class="list-group-item">Employee training on <strong>2025-06-10</strong>.</li>
                    </ul>
                </div>
            </div>
            <!-- Footer -->
...
<script>
    ...
    document.querySelectorAll('.edit-employee').forEach(button => {
        button.addEventListener('click', function() {
            ...
            form.querySelector('[name="name"]').value = 'John Smith';
            form.querySelector('[name="email"]').value = 'john@example.com';
            form.querySelector('[name="role"]').value = 'Loan Officer';
        });
    });
    document.getElementById('editEmployeeForm').addEventListener('submit', async function(e) {
        ...
        const employeeData = Object.fromEntries(formData);
        try {
            const response = await fetch(`/api/employees/${employeeData.employeeId}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(employeeData)
            });
    ...
    document.getElementById('assignLeadForm').addEventListener('submit', async function(e) {
        e.preventDefault();
        const formData = new FormData(e.target);
        const leadData = Object.fromEntries(formData);
        try {
            const response = await fetch(`/api/leads/${leadData.leadId}/assign`, {
                method: 'PATCH',
                headers: { 'Content-Type': 'application/json' },
