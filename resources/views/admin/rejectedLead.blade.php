...
@section('title', 'Rejected KYC Users')
    ...
    <main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4 main-content">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <div class="d-flex align-items-center gap-2">
                ...
                <h2 class="h3 mb-0 fw-bold">Rejected KYC Users</h2>
            </div>
            <div class="d-flex align-items-center gap-2">
        ...
        @if ($leads->isEmpty())
            <div class="alert alert-info text-center" role="alert">
                No rejected KYC users found.
            </div>
        @else
            <div class="excel-table-container">
                <table class="excel-table" role="grid" aria-describedby="rejectedKycUsersTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($leads as $lead)
                            <tr>
                                ...
                                <td class="status-closed">{{ $lead->status ?? 'Rejected' }}</td>
                                <td>{{ $lead->rejection_reason ?? 'N/A' }}</td>
                                <td>{{ $lead->created_at ? \Carbon\Carbon::parse($lead->created_at)->format('d/m/Y H:i') : 'N/A' }}</td>
                                <td>
                                    <a href="{{ route('employee.viewLeadDetails', $lead->lead_id) }}" class="action-btn" data-bs-toggle="tooltip" data-bs-title="View Details">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.sidebar .nav-link').forEach(link => {
            ...
            if (link.getAttribute('href') === '{{ route('admin.rejectedLead') }}') {
