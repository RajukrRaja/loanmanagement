...
@section('title', 'Pending KYC Users')
    ...
    <main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4 main-content">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <div class="d-flex align-items-center gap-2">
                <button class="btn btn-outline-primary sidebar-toggle" id="sidebarToggle" data-bs-toggle="tooltip" title="Toggle Sidebar"><i class="fas fa-bars"></i></button>
                <h2 class="h3 mb-0 fw-bold">Pending KYC Users</h2>
            </div>
            <div class="d-flex align-items-center gap-2">
                <input type="text" class="form-control search-bar" id="searchInput" placeholder="Search leads..." value="{{ request()->query('search', '') }}">
        ...
        @else
            <div class="excel-table-container">
                <table class="excel-table" role="grid" aria-describedby="pendingKycUsersTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($leads as $lead)
                            <tr>
                                ...
                                <td class="status-closed">{{ $lead->status ?? 'Pending' }}</td>
                                <td>{{ $lead->created_at ? \Carbon\Carbon::parse($lead->created_at)->format('d/m/Y H:i') : 'N/A' }}</td>
                                <td>
                                    <a href="{{ route('employee.viewLeadDetails', $lead->lead_id) }}" class="action-btn" data-bs-toggle="tooltip" title="View Details">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.sidebar .nav-link').forEach(link => {
            ...
            if (link.getAttribute('href') === '{{ route('admin.pendingLead') }}') {
        ...
        window.routes = {
            viewLeadDetails: "{{ route('employee.viewLeadDetails', ':id') }}"
        };
    });
</script>
@endsection
