    ...
    <main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4 main-content">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <div class="d-flex align-items-center gap-2">
                <button class="btn btn-outline-primary sidebar-toggle" id="sidebarToggle" data-bs-toggle="tooltip" data-bs-title="Toggle Sidebar"><i class="fas fa-bars"></i></button>
                <h2 class="h3 mb-0 fw-bold">Overdue EMI Report</h2>
            </div>
            <div class="d-flex align-items-center gap-2">
